      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-700 py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-green-100 mb-6 max-w-xl mx-auto">
            Become a member of Nek Kaam Foundation and help us build stronger communities through transparency and collective effort.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Dedicated to building trust, supporting communities, and bringing positive change through collective efforts and complete financial transparency.
              </p>
              {/* Social Links */}
            ...
            {/* Our Work */}
            <div>
              <h4 className="text-white font-bold text-base mb-5">Our Work</h4>
              <ul className="space-y-3">
                {[
